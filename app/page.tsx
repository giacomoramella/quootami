...
import { ContattoRapido } from '@/components/ContattoRapido';
...
/** Voci del menu "di cosa hai bisogno" nel contatto rapido. Calcolate qui, in
 *  un Server Component: passarle come prop evita di trascinare config/polizze
 *  (contenuti + FAQ di tutti i prodotti) nel bundle client della home. */
const AREE_CONTATTO = getAllPolizze().map(p => p.title);
...
export default function HomePage() {
  return (
    <>
      ...
      <ContattoRapido aree={AREE_CONTATTO} />
