...
//
// TODO prima del deploy: aggiornare SITE, FROM (dominio verificato su Resend)
// e LANDING_URL (default) con i valori definitivi Quootami/Luce.
...
const LANDING = Deno.env.get('LANDING_URL') || 'https://TODO-dominio-quootami/en.confronta.html';
const FROM = Deno.env.get('FROM_EMAIL') || 'Quootami Energia <onboarding@resend.dev>';
const SITE = 'TODO-dominio-quootami';
