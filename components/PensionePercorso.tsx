...
export function PensionePercorso() {
  return (
    <section id="percorso" className="section bg-bg-alt">
      <div className="container-content">
        ...
        <ol className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 list-none">
          ...
          <TappaCard n={4} tempo="diretto" titolo="Richiedi la stima" desc="Scrivi o chiama: Quootami elabora una stima previdenziale sul tuo profilo." cta="Richiedi" href="#preventivo" />
        </ol>
